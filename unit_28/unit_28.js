...
let goods = new Goods('1984', 112, 'https://content.rozetka.com.ua/goods/images/big/124278673.jpg', 20);
console.log(goods);
...
let goods2 = new Goods('Metro 2033', 400, 'https://content.rozetka.com.ua/goods/images/big/224209054.jpg', 11);
goods2.draw('.out-4');
//Task 5.
...
let goods3 = new Goods2('Нездоланні', 195, 'https://content2.rozetka.com.ua/goods/images/big/66910798.jpg', 22, true);
goods3.draw('.out-6');
// Task 7.
...
let validation = new Valid('email', '12345');
validation.validate();
...
let validation2 = new Valid('email', 1234567);
validation2.validate();
console.log(validation2.isValid);
...
let valid3 = new Valid2('email@gmail.com', 12345678);
valid3.validate();
console.log(valid3);