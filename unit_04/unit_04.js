...
function f7() {
    let pas = document.querySelector('.i-7');
    let length = pas.value.length;
    let out = 0;
    // console.log(pas.value.length);
    // console.log(pas.value);
    if (length >= 6) {
        out = 1;
    }

    document.querySelector('.out-71').innerHTML = pas.value;
    document.querySelector('.out-72').innerHTML = out;
}
...
function f13() {
    let out = document.querySelector('.i-13').value;
...
function f16() {
    ...
    let out = document.querySelector('.s-16').value;
...
function f17() {
    let out = document.querySelector('.s-17').value;
...
function f18() {
    let val = document.querySelector('.s-18').value;
    document.querySelector('.i-18').value = val;
}
...
function f19() {
    let val = document.querySelector('.out-19').innerHTML;
    document.querySelector('.i-19').value = val;
}
...
function f20() {
    let val = document.querySelector('.s-201').value;
    document.querySelector('.s-202').value = val;
}
