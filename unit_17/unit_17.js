...
function t3() {
    a3_res = a3.map(item => Number(item));
    return a3_res;
}
...
function t5() {
    a5_res = a5.filter(item => item % 2 === 0 && typeof item === 'number');
    return a5_res;
}
...
function t6() {
    a6_res = a6.filter(item => item > 14 && typeof item === 'number');
    return a6_res;
}
...
function t9() {
    let arr = [];
    a9.forEach(item => arr.push(item.toLocaleLowerCase()));
    return a9 = arr;
}
