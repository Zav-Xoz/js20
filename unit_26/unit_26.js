...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=4&num2=6')
        .then(data => data.text())
        .then(data => document.querySelector('.out-3').innerHTML = data)
    // .then(data => myF(data))
}
// let myF = (text) => document.querySelector('.out-3').innerHTML = text;
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=9&num2=16')
        .then(data => data.text())
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=90&num2=14')
        .then(data => data.text())
...
function t12() {
    fetch("http://getpost.itgid.info/index2.php", {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=3&num1=2&num2=2', // тип данных в body должен соответвовать значению заголовка "Content-Type"
    })
        .then(response => response.text())
...
function t13() {
    fetch("http://getpost.itgid.info/index2.php", {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=4&num1=22&num2=42', // тип данных в body должен соответвовать значению заголовка "Content-Type"
    })
        .then(response => response.text())
...
function t15() {
    fetch("http://getpost.itgid.info/index2.php", {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=6&num1=22&num2=42', // тип данных в body должен соответвовать значению заголовка "Content-Type"
    })
        .then(response => response.text())
