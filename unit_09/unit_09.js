...
function f2() {
    let block = document.querySelector('.out-2');
...
function f3() {
    let block = document.querySelector('.out-3');
...
function f4() {
    let block = document.querySelector('.out-4');
...
function f5() {
    ...
    if (block.classList.contains('bg-orange')) {
        out = true;
    } else {
        out = false;
    }
...
function f6() {
    ...
    document.querySelector('.out-6').innerHTML = paragraphs.length;
}
...
function f12() {
    ...
    document.querySelector('.out-12').append(d);
}
...
function f18() {
    let attribute = document.querySelector('.p-18').getAttribute('data-b');
    document.querySelector('.out-18').innerHTML = attribute;
}
...
function f19() {
    let divs = document.querySelectorAll('.p-19');
    let out = '';

    for (let i = 0; i < divs.length; i++) {
        out += divs[i].getAttribute('data-b') + ' ';
    }
