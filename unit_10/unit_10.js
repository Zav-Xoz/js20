...
let ar1 = [1, 'text', 4, false, 'second', true];
...
let ar2 = [2, 'qwe', 4, true, 'abba', false];
...
// let ar6 =
let ar6 = ['Sergii', 'Virgo', 16, 'September'];
...
function f12() {
    let variable = ar12[ar12.length - 1];
...
function f17() {
    ...
    document.querySelector('.out-17').innerHTML = num;
}
...
function f19() {
    ...
    document.querySelector('.out-19').innerHTML = minI;
}
